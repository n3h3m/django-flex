...
| `allowed_actions` | list | Optional. Allowed actions (default: ['get', 'list']) |
...
```python
from django_flex import get_json_fields
...
```python
from django_flex import is_json_field_path
...
| `EXPOSE` | dict | {} | Model permissions configuration |
